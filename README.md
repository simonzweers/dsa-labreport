...
```bash
sudo dnf install inkscape latexmk texlive texlive-{amsmath,tcolorbox,svg,circuitikz,minted,roboto,ucs,todonotes,titling,blindtext,sectsty,tikzpagenodes,helvetic,karnaugh-map} python3
```
